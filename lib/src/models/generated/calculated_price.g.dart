...
abstract class _$CalculatedPriceCWProxy {
  CalculatedPrice id(String id);

  CalculatedPrice calculatedAmount(num? calculatedAmount);

  CalculatedPrice originalAmount(num? originalAmount);

  CalculatedPrice currencyCode(String? currencyCode);

  CalculatedPrice originalAmountWithTax(num? originalAmountWithTax);

  CalculatedPrice originalAmountWithoutTax(num? originalAmountWithoutTax);

  CalculatedPrice originalPrice(Map<String, dynamic>? originalPrice);
  ...
  CalculatedPrice calculatedAmountWithoutTax(num? calculatedAmountWithoutTax);
  ...
  /// Usage
  /// ```dart
  /// CalculatedPrice(...).copyWith(id: 12, name: "My name")
  /// ````
  CalculatedPrice call({
    ...
    num? originalAmount,
    String? currencyCode,
    num? originalAmountWithTax,
    num? originalAmountWithoutTax,
    Map<String, dynamic>? originalPrice,
    Map<String, dynamic>? calculatedPrice,
    bool? isOriginalPriceTaxInclusive,
    bool? isOriginalPricePriceList,
    num? calculatedAmountWithoutTax,
    num? calculatedAmountWithTax,
    bool? isCalculatedPriceTaxInclusive,
    bool? isCalculatedPricePriceList,
  });
}

/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfCalculatedPrice.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfCalculatedPrice.copyWith.fieldName(...)`
class _$CalculatedPriceCWProxyImpl implements _$CalculatedPriceCWProxy {
  const _$CalculatedPriceCWProxyImpl(this._value);

  final CalculatedPrice _value;

  @override
  CalculatedPrice id(String id) => this(id: id);
  ...
  CalculatedPrice call({
    ...
    Object? calculatedAmount = const $CopyWithPlaceholder(),
    Object? originalAmount = const $CopyWithPlaceholder(),
    Object? currencyCode = const $CopyWithPlaceholder(),
    Object? originalAmountWithTax = const $CopyWithPlaceholder(),
    Object? originalAmountWithoutTax = const $CopyWithPlaceholder(),
    Object? originalPrice = const $CopyWithPlaceholder(),
    Object? calculatedPrice = const $CopyWithPlaceholder(),
    Object? isOriginalPriceTaxInclusive = const $CopyWithPlaceholder(),
    Object? isOriginalPricePriceList = const $CopyWithPlaceholder(),
    Object? calculatedAmountWithoutTax = const $CopyWithPlaceholder(),
    Object? calculatedAmountWithTax = const $CopyWithPlaceholder(),
    Object? isCalculatedPriceTaxInclusive = const $CopyWithPlaceholder(),
    Object? isCalculatedPricePriceList = const $CopyWithPlaceholder(),
  }) {
    return CalculatedPrice(
      id: id == const $CopyWithPlaceholder()
          ...
          : id as String,
      calculatedAmount: calculatedAmount == const $CopyWithPlaceholder()
          ? _value.calculatedAmount
          // ignore: cast_nullable_to_non_nullable
          : calculatedAmount as num?,
      originalAmount: originalAmount == const $CopyWithPlaceholder()
          ? _value.originalAmount
          // ignore: cast_nullable_to_non_nullable
          : originalAmount as num?,
      ...
      originalPrice: originalPrice == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : originalPrice as Map<String, dynamic>?,
...
extension $CalculatedPriceCopyWith on CalculatedPrice {
  /// Returns a callable class that can be used as follows: `instanceOfCalculatedPrice.copyWith(...)` or like so:`instanceOfCalculatedPrice.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$CalculatedPriceCWProxy get copyWith => _$CalculatedPriceCWProxyImpl(this);
}
