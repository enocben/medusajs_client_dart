...
Map<String, dynamic> _$CartToJson(Cart instance) => <String, dynamic>{
      ...
      if (instance.billingAddressId case final value?)
      ...
      if (instance.salesChannel?.toJson() case final value?)
        'sales_channel': value,
      ...
      if (instance.rawDiscountTotal case final value?)
        'raw_discount_total': value,
      ...
      if (instance.refundableAmount case final value?)
