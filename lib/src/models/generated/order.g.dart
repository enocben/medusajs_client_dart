...
Order _$OrderFromJson(Map<String, dynamic> json) => Order(
  ...
  draftOrder: DraftOrder.fromJson(json['draft_order'] as Map<String, dynamic>),
...
Map<String, dynamic> _$OrderToJson(Order instance) => <String, dynamic>{
  ...
  'gift_card_transactions': instance.giftCardTransactions
      .map((e) => e.toJson())
      .toList(),
  ...
  'returnable_items': instance.returnableItems.map((e) => e.toJson()).toList(),
