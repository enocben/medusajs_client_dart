...
ExchangeOrderItem _$ExchangeOrderItemFromJson(Map<String, dynamic> json) =>
    ExchangeOrderItem(
      ...
      adjustments: (json['adjustments'] as List<dynamic>?)
          ?.map((e) =>
              ExchangeOrderItemAdjustment.fromJson(e as Map<String, dynamic>))
          .toList(),
      taxLines: (json['tax_lines'] as List<dynamic>?)
          ?.map((e) =>
              ExchangeOrderItemTaxLine.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$ExchangeOrderItemToJson(ExchangeOrderItem instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      if (instance.productCollection case final value?)
