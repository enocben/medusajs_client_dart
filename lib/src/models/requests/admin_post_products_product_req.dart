...
class AdminPostProductsProductReq {
  ...
  final List<AdminPostImageUrlReq>? images;
...
@JsonSerializable()
class AdminPostImageUrlReq {
  AdminPostImageUrlReq({required this.url});
  factory AdminPostImageUrlReq.fromJson(Map<String, dynamic> json) =>
      _$AdminPostImageUrlReqFromJson(json);

  Map<String, dynamic> toJson() => _$AdminPostImageUrlReqToJson(this);
  final String url;
}
