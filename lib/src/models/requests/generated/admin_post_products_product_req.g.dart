...
AdminPostProductsProductReq _$AdminPostProductsProductReqFromJson(
  ...
  variants: (json['variants'] as List<dynamic>?)
      ?.map(
        (e) => AdminPostProductsProductReqVariant.fromJson(
...
AdminPostProductById _$AdminPostProductByIdFromJson(
  Map<String, dynamic> json,
) => AdminPostProductById(id: json['id'] as String);
...
AdminPostImageUrlReq _$AdminPostImageUrlReqFromJson(
  Map<String, dynamic> json,
) => AdminPostImageUrlReq(url: json['url'] as String);
...
_$AdminPostProductsProductReqSalesChannelFromJson(Map<String, dynamic> json) =>
    AdminPostProductsProductReqSalesChannel(id: json['id'] as String);
