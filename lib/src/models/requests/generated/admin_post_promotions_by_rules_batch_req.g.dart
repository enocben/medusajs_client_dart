...
_$AdminPostPromotionsBuyRulesBatchReqFromJson(
  ...
  update: (json['update'] as List<dynamic>?)
      ?.map(
        (e) =>
            AdminPostUpdatePromotionRuleReq.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  create: (json['create'] as List<dynamic>?)
      ?.map(
        (e) =>
            AdminPostCreatePromotionRuleReq.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
