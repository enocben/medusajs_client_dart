...
AdminPostProductsReq _$AdminPostProductsReqFromJson(
  ...
  tags: (json['tags'] as List<dynamic>?)
      ?.map((e) => AdminPostProductsReqTag.fromJson(e as Map<String, dynamic>))
      .toList(),
  salesChannels: (json['sales_channels'] as List<dynamic>?)
      ?.map(
        (e) => AdminPostProductsReqSalesChannel.fromJson(
  ...
  categories: (json['categories'] as List<dynamic>?)
      ?.map(
        (e) => AdminPostProductsReqCategory.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  options: (json['options'] as List<dynamic>?)
      ?.map(
        (e) => AdminPostProductsReqOption.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  variants: (json['variants'] as List<dynamic>?)
      ?.map(
        (e) => AdminPostProductsReqVariant.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
...
AdminPostProductsReqSalesChannel _$AdminPostProductsReqSalesChannelFromJson(
  Map<String, dynamic> json,
) => AdminPostProductsReqSalesChannel(id: json['id'] as String);
...
AdminPostProductsReqCategory _$AdminPostProductsReqCategoryFromJson(
  Map<String, dynamic> json,
) => AdminPostProductsReqCategory(id: json['id'] as String);
