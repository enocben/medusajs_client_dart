...
class AdminPostSalesChannelsManageProductsReq {
  ...
  factory AdminPostSalesChannelsManageProductsReq.fromJson(Map<String, dynamic> json) =>
      _$AdminPostSalesChannelsManageProductsReqFromJson(json);

  Map<String, dynamic> toJson() => _$AdminPostSalesChannelsManageProductsReqToJson(this);
