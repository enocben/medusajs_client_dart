...
class AdminPostStockLocationSalesChannelsReq {
  ...
  factory AdminPostStockLocationSalesChannelsReq.fromJson(Map<String, dynamic> json) =>
  ...
  Map<String, dynamic> toJson() => _$AdminPostStockLocationSalesChannelsReqToJson(this);
}
