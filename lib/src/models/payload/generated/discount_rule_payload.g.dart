...
DiscountRulePayload _$DiscountRulePayloadFromJson(
  Map<String, dynamic> json,
) => DiscountRulePayload(
  description: json['description'] as String?,
  type: $enumDecode(_$DicountRuleTypeEnumMap, json['type']),
  value: (json['value'] as num).toInt(),
  allocation: $enumDecode(_$DiscountRuleAllocationEnumMap, json['allocation']),
  conditions: (json['conditions'] as List<dynamic>?)
      ?.map(
        (e) => DiscountRuleConditionPayload.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
