...
class _ApiKeysResource implements ApiKeysResource {
  _ApiKeysResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminGetApiKeysRes> list({
    ...
    final _options = _setStreamType<AdminGetApiKeysRes>(
  ...
  Future<AdminGetApiKeysApiKeyRes> create(
    ...
    final _options = _setStreamType<AdminGetApiKeysApiKeyRes>(
