...
class _AdminSellersResource implements AdminSellersResource {
  _AdminSellersResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminSellersRes> list({
    ...
    final _options = _setStreamType<AdminSellersRes>(
    ...
    late AdminSellersRes _value;
    try {
      _value = AdminSellersRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminSellerRes> retrieve(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminSellerRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/sellers/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminSellerRes _value;
    try {
      _value = AdminSellerRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminSellerInvitationRes> invite(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<AdminSellerInvitationRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminSellerInvitationRes _value;
    try {
      _value = AdminSellerInvitationRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
