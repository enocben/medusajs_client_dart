...
class _BatchJobsResource implements BatchJobsResource {
  _BatchJobsResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminBatchJobRes> cancel(
    ...
    final _options = _setStreamType<AdminBatchJobRes>(
    ...
    late AdminBatchJobRes _value;
    try {
      _value = AdminBatchJobRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminBatchJobListRes> list({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminBatchJobListRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/batch-jobs',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminBatchJobListRes _value;
    try {
      _value = AdminBatchJobListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
