...
class _DraftOrdersResource implements DraftOrdersResource {
  ...
  Future<AdminDraftOrdersListRes> list({
    ...
    final _options = _setStreamType<AdminDraftOrdersListRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminDraftOrdersRes> create(
    ...
    final _options = _setStreamType<AdminDraftOrdersRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminDraftOrdersDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminDraftOrdersDeleteRes>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
