...
class _DraftOrdersResource implements DraftOrdersResource {
  _DraftOrdersResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminDraftOrdersListRes> list({
    ...
    final _options = _setStreamType<AdminDraftOrdersListRes>(
    ...
    late AdminDraftOrdersListRes _value;
    try {
      _value = AdminDraftOrdersListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminDraftOrdersRes> create(
    ...
    final _options = _setStreamType<AdminDraftOrdersRes>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminDraftOrdersRes _value;
    try {
      _value = AdminDraftOrdersRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminDraftOrdersDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminDraftOrdersDeleteRes>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminDraftOrdersDeleteRes _value;
    try {
      _value = AdminDraftOrdersDeleteRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminPostDraftOrdersDraftOrderRegisterPaymentRes> markPaid(
    ...
    try {
      _value = AdminPostDraftOrdersDraftOrderRegisterPaymentRes.fromJson(
        _result.data!,
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
