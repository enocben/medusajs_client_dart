...
class _ProductCategoriesResource implements ProductCategoriesResource {
  _ProductCategoriesResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminProductCategoriesListRes> list({
    ...
    final _options = _setStreamType<AdminProductCategoriesListRes>(
  ...
  Future<AdminProductCategoriesCategoryRes> create(
    ...
    final _options = _setStreamType<AdminProductCategoriesCategoryRes>(
  ...
  Future<AdminProductCategoriesCategoryDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminProductCategoriesCategoryDeleteRes>(
