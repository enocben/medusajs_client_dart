...
class _PaymentsResource implements PaymentsResource {
  _PaymentsResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminPaymentRes> retrieve(
    ...
    final _options = _setStreamType<AdminPaymentRes>(
    ...
    late AdminPaymentRes _value;
    try {
      _value = AdminPaymentRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminRefundRes> refundPayment(
    ...
    final _options = _setStreamType<AdminRefundRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminRefundRes _value;
    try {
      _value = AdminRefundRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
