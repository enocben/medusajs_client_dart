...
class _PriceListsResource implements PriceListsResource {
  _PriceListsResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminPriceListRes> create(
    AdminPostCreatePriceListReq payload, {
    Map<String, String>? customHeaders,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(customHeaders ?? <String, dynamic>{});
    ...
    final _options = _setStreamType<AdminPriceListRes>(
  ...
  Future<AdminPriceListRes> update(
    String id,
    AdminPostUpdatePriceListReq payload, {
    Map<String, String>? customHeaders,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(customHeaders ?? <String, dynamic>{});
  ...
  Future<AdminPriceListDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminPriceListDeleteRes>(
  ...
  Future<AdminPriceListsProductsListRes> listProducts(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminPriceListsProductsListRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AdminPriceListRes> deleteProducts(
    String priceListId,
    AdminDeleteProductPriceListReq body, {
    Map<String, String>? customHeaders,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(customHeaders ?? <String, dynamic>{});
  ...
  Future<AdminPriceListManagePricesRes> managePrices(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(payload.toJson());
    final _options = _setStreamType<AdminPriceListManagePricesRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminPriceListManagePricesRes _value;
    try {
      _value = AdminPriceListManagePricesRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminPriceListDeleteProductPricesRes> deleteProductPrices(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminPriceListDeleteProductPricesRes>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AdminPriceListDeleteVariantPricesRes> deleteVariantPrices(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminPriceListDeleteVariantPricesRes>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
