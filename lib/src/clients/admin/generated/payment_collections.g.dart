...
class _PaymentCollectionsResource implements PaymentCollectionsResource {
  _PaymentCollectionsResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminPaymentCollectionsRes> retrieve(
    ...
    final _options = _setStreamType<AdminPaymentCollectionsRes>(
    ...
    late AdminPaymentCollectionsRes _value;
    try {
      _value = AdminPaymentCollectionsRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminPaymentCollectionDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminPaymentCollectionDeleteRes>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminPaymentCollectionDeleteRes _value;
    try {
      _value = AdminPaymentCollectionDeleteRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
