...
part of '../requests_resource.dart';
...
class _AdminRequestsResource implements AdminRequestsResource {
  ...
  Future<AdminRequestsRes> list({
    ...
    final _options = _setStreamType<AdminRequestsRes>(
    ...
    late AdminRequestsRes _value;
    try {
      _value = AdminRequestsRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminRequestRes> retrieve(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminRequestRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/requests/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminRequestRes _value;
    try {
      _value = AdminRequestRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
