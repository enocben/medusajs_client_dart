...
class _GiftCardsResource implements GiftCardsResource {
  ...
  Future<AdminGiftCardsListRes> list({
    ...
    final _options = _setStreamType<AdminGiftCardsListRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminGiftCardsRes> create(
    ...
    final _options = _setStreamType<AdminGiftCardsRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminGiftCardsDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminGiftCardsDeleteRes>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
