...
class _ShippingOptionsResource implements ShippingOptionsResource {
  _ShippingOptionsResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminShippingOptionsListRes> list({
    ...
    final _options = _setStreamType<AdminShippingOptionsListRes>(
  ...
  Future<AdminShippingOptionsRes> create(
    ...
    final _options = _setStreamType<AdminShippingOptionsRes>(
  ...
  Future<AdminShippingOptionsDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminShippingOptionsDeleteRes>(
