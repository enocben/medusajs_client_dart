...
class _SalesChannelsResource implements SalesChannelsResource {
  ...
  Future<AdminSalesChannelsListRes> list({
    ...
    final _options = _setStreamType<AdminSalesChannelsListRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late AdminSalesChannelsListRes _value;
    try {
      _value = AdminSalesChannelsListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminSalesChannelsDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminSalesChannelsDeleteRes>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminSalesChannelsDeleteRes _value;
    try {
      _value = AdminSalesChannelsDeleteRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
