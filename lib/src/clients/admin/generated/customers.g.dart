...
class _CustomersResource implements CustomersResource {
  _CustomersResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AdminCustomersRes> create(
    ...
    final _options = _setStreamType<AdminCustomersRes>(
  ...
  Future<AdminCustomersRes> addRemoveCustomerInGroup(
    String customerId,
    AdminPostGroupsCustomerBodyReq body, {
    AdminGetCustomerParams? query,
    Map<String, String>? customHeaders,
  }) async {
    final _extra = <String, dynamic>{};
  ...
  Future<AdminCustomersRes> addAddress(
    String customerId,
    AdminPostAddressReq body, {
    AdminGetAddressParams? query,
    Map<String, String>? customHeaders,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(customHeaders ?? <String, dynamic>{});
  ...
  Future<AdminCustomersAddressesListRes> listAddresses(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminCustomersAddressesListRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/customers/${customerId}/addresses',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminCustomersAddressesListRes _value;
    try {
      _value = AdminCustomersAddressesListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminCustomerAddressRes> getAddress(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminCustomerAddressRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminCustomerAddressRes _value;
    try {
      _value = AdminCustomerAddressRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminDeleteCustomerAddressRes> deleteAddress(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminDeleteCustomerAddressRes>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminDeleteCustomerAddressRes _value;
    try {
      _value = AdminDeleteCustomerAddressRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
