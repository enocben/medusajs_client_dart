...
class _ProductCategoriesResource implements ProductCategoriesResource {
  ...
  Future<StoreGetProductCategoriesCategoryRes> retrieve(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StoreGetProductCategoriesCategoryRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late StoreGetProductCategoriesCategoryRes _value;
    try {
      _value = StoreGetProductCategoriesCategoryRes.fromJson(_result.data!);
    } on Object catch (e, s) {
