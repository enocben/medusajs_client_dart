...
class _OrderEditsResource implements OrderEditsResource {
  _OrderEditsResource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<StoreOrderEditsRes> retrieve(
    ...
    final _options = _setStreamType<StoreOrderEditsRes>(
    ...
    late StoreOrderEditsRes _value;
    try {
      _value = StoreOrderEditsRes.fromJson(_result.data!);
    } on Object catch (e, s) {
