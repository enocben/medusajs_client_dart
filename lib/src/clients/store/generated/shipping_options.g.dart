...
class _ShippingOptionsResource implements ShippingOptionsResource {
  ...
  Future<StoreShippingOptionsListRes> list({
    ...
    final _options = _setStreamType<StoreShippingOptionsListRes>(
    ...
    late StoreShippingOptionsListRes _value;
    try {
      _value = StoreShippingOptionsListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
