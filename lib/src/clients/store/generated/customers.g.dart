...
class _CustomersResource implements CustomersResource {
  ...
  Future<StoreCustomersRes> create(
    ...
    final _options = _setStreamType<StoreCustomersRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late StoreCustomersRes _value;
    try {
      _value = StoreCustomersRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<StoreCustomersListOrdersRes> listOrders({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StoreCustomersListOrdersRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late StoreCustomersListOrdersRes _value;
    try {
      _value = StoreCustomersListOrdersRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
